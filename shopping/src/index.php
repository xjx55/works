  ...
  <body>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">XJX电商平台</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                ?>
                <li><a href="javascript:;">欢迎您：<?php echo $_SESSION['user'][0]['username']; ?></a></li>
                <li>
                    <a id="logout" href="javascript:;">退出</a>
                </li>
                <?php } else{?>
                <li><a href="admin/login.html">登录</a></li>
                <li><a href="admin/sign.html">注册</a></li>
                <?php } ?>
    ...
    <div class="container marketing">
      ...
      <div id="gList" class="row">
        <div class="col-md-3">
          <div class="thumbnail">
            ...
            <p>
              ...
              <a href="javascript:;" class="btn btn-default" role="button">加入购物车</a>
            </p>
          </div>
          </div>
        </div>
        ...
        <!-- <div class="col-lg-4">
          <img class="img-circle" src="../img/5.jpg" style="width: 140px; height: 140px;">
          <h2>Heading</h2>
          <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>/.col-lg-4
        <div class="col-lg-4">
          <img class="img-circle" src="../img/6.jpg" style="width: 140px; height: 140px;">
          <h2>Heading</h2>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>/.col-lg-4
        <div class="col-lg-4">
          <img class="img-circle" src="../img/7.jpg" style="width: 140px; height: 140px;">
          <h2>Heading</h2>
    ...
    <script id="gListTpl" type="text/x-handlebars-template">
      ...
      <div class="col-md-3">
        <div class="thumbnail">
          ...
          <p title="{{details}}">{{strCutd details}}</p>
          <p>
            <a href="javascript:;" class="btn btn-primary" role="button">加入购物车</a>
            <a href="javascript:;" class="btn btn-default" role="button">加入购物车</a>
          </p>
    ...
    <script src="../../bower/js/lib/handlebars/handlebars.min.js"></script>
